...
import vib.application.modular.compilation.JarMaker;
import vib.application.modular.compilation.ZipMaker;
import vib.application.modular.modules.Library;
import vib.application.modular.modules.Style;
import vib.application.modular.tools.ConnectorEditor;
import vib.application.modular.tools.EditorFrame;
import vib.application.modular.tools.LibEditor;
import vib.application.modular.tools.MenuEditor;
import vib.application.modular.tools.ModuleEditor;
import vib.application.modular.tools.StyleEditor;
...
//        editStyleMenuItem.setEnabled(false);
    ...
    private javax.swing.JMenu buildLAFMenu(){
        javax.swing.JMenu looks = new vib.core.utilx.gui.ToolBox.LocalizedJMenu("modular.look");
        javax.swing.JMenu styles = new vib.core.utilx.gui.ToolBox.LocalizedJMenu("Graph");
        ...
        looks.add(styles);
        javax.swing.JMenu lafs = new vib.core.utilx.gui.ToolBox.LocalizedJMenu("Java");
            ...
            laf.addActionListener(new java.awt.event.ActionListener(){
                ...
                public void actionPerformed(java.awt.event.ActionEvent e) {
                    try {
                        ...
                        for(vib.application.modular.modules.Module module : moduleGraph.getModules()){
    ...
    private javax.swing.JMenu buildOptionMenu(){
        javax.swing.JMenu option = new vib.core.utilx.gui.ToolBox.LocalizedJMenu("GUI.options");

        option.add(new LanguageMenu(this));
        option.add(buildLAFMenu());
        final JCheckBoxMenuItem loadLast = new vib.core.utilx.gui.ToolBox.LocalizedJCheckBoxMenuItem("modular.load.last.file");
    ...
    private void initComponents() {
        ...
        moduleGraph = new vib.application.modular.ModuleGraph();
        ...
        newConfigItem = new vib.core.utilx.gui.ToolBox.LocalizedJMenuItem("GUI.new");
        openConfigItem = new vib.core.utilx.gui.ToolBox.LocalizedJMenuItem("GUI.open");
        saveConfigItem = new vib.core.utilx.gui.ToolBox.LocalizedJMenuItem("GUI.save");
        saveAsConfigItem = new vib.core.utilx.gui.ToolBox.LocalizedJMenuItem("GUI.saveAs");
        jSeparator1 = new javax.swing.JPopupMenu.Separator();
        compileConfigItem = new vib.core.utilx.gui.ToolBox.LocalizedJMenuItem("GUI.compile");
        jSeparator2 = new javax.swing.JPopupMenu.Separator();
        exitMenuItem = new vib.core.utilx.gui.ToolBox.LocalizedJMenuItem("GUI.exit");
        editMenu = new vib.core.utilx.gui.ToolBox.LocalizedJMenu("GUI.edit");
        editMenuMenuItem = new vib.core.utilx.gui.ToolBox.LocalizedJMenuItem("modular.edit.menu");
        editModuleMenuItem = new vib.core.utilx.gui.ToolBox.LocalizedJMenuItem("modular.edit.module");
        editLibMenuItem = new vib.core.utilx.gui.ToolBox.LocalizedJMenuItem("modular.edit.lib");
        editConnectorMenuItem = new vib.core.utilx.gui.ToolBox.LocalizedJMenuItem("modular.edit.connector");
        editStyleMenuItem = new vib.core.utilx.gui.ToolBox.LocalizedJMenuItem("modular.edit.style");
    ...
    private void compileConfigItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_compileConfigItemActionPerformed
        ...
        String packageName = "vib.generated";
