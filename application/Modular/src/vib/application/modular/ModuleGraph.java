...
import vib.application.modular.compilation.SourceFile;
import vib.application.modular.modules.Connection;
...
import vib.application.modular.tools.PrimitiveTypes;
...
//            graph.getModel().endUpdate();
    ...
    public SourceCode generateSourceCode(String className, String packageName, String baseFileName) {
        ...
        vib.core.util.IniManager iniManager = null;
        ...
        String code = "";
        code += "/*\n * This file was auto-generated by the VIB's Modular software.\n */\n";
        code += "package "+packageName+";\n\n";

        //imports for each module classes
        ArrayList<String> imported = new ArrayList<String>();
        if(iniManager !=null){
            code += "import vib.core.util.IniManager;\n";
            imported.add(iniManager.getClass().getName());
            source.addLibrary(Library.getLibrary("vib_util")); //it's a little tricky....
        }
        ...
        code += "/**\n * This class builds a VIB application.\n * @author Modular\n */\n";
        ...
        code += "\n"+
                ...
                "            input = scanner.next();\n" +
                "        }\n" +
                "        System.out.println(\"Exiting VIB.\");\n" +
                "        System.exit(0);\n";
