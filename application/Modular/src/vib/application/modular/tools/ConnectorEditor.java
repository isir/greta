...
//            items.add(nothingToConnect);
    ...
    private void initComponents() {
        ...
        newConnectorButton = new vib.core.utilx.gui.ToolBox.LocalizedJButton("modular.edit.connector.new")  ;
        deleteConnectorButton = new vib.core.utilx.gui.ToolBox.LocalizedJButton("modular.edit.connector.delete")  ;
        ...
        uniqueCheckBox = new vib.core.utilx.gui.ToolBox.LocalizedJCheckBox("modular.edit.connector.unique")
        ;
