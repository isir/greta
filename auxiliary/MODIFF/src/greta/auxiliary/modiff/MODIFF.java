 ...
 * @author Michele
 */
public class MODIFF implements Runnable{

    
    protected static final Logger LOGGER = Logger.getLogger(MODIFF.class.getName());
    
    protected MODIFFFrame loader;
    ...
    protected final String threadName = MODIFF.class.getSimpleName();
    protected double frameDuration = 0.0;
    protected MODIFFFrame curFrame = new MODIFFFrame(cm);
    // protected MODIFFFrame prevFrame = new MODIFFFrame(cm);
    ...
    public MODIFF(CharacterManager cm, MODIFFFrame loader){
        this.cm=cm;
        this.loader=loader;
    }
...
@Override
    ...
    public void run() {
        LOGGER.info(String.format("Thread: %s running", MODIFF.class.getName()));
        // Socket Connection
    }
