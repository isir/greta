...
import vib.auxiliary.player.ogre.agent.AgentFactory;
import vib.auxiliary.player.ogre.agent.MPEG4Agent;
...
public class OgreEnvironementListener implements EnvironmentEventListener{
    ...
    private void readTree(TreeNode treeNode, SceneNode sceneNode){
        ...
        //parse children
        for(vib.core.util.environment.Node childTreeNode : treeNode.getChildren()){
