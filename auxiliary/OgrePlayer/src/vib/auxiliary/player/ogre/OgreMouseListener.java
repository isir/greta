                ...
                if (me.isControlDown() || pivot == null) {
                    ...
                    Ogre.callSync(new OgreThread.Callback() {
                        ...
                        public void run() {
                            ...
                            vib.core.util.math.Quaternion yaw = new vib.core.util.math.Quaternion(new Vec3d(0,1,0), yawAngle);

                            Vec3d pitchAxis = (new Vec3d(0,-1,0)).cross3(direction);
                            vib.core.util.math.Quaternion pitch = new vib.core.util.math.Quaternion(pitchAxis, pitchAngle);
