...
public class SceneNode extends _Object_ implements Node {
    ...
    //vib.auxiliary.player.ogre.natives.Node.TransformSpace.TS_LOCAL
    ...
    public void setPosition(vib.core.util.math.Vec3d v) {
    ...
    public void setScale(vib.core.util.math.Vec3d v) {
