 ...
 */
package furhat.greta.audiosender.cereproc;
 ...
 * @author Admin
 */
public class ActivemqGretaFurhatSender extends TextSender {
    
    private HashMap<String,Object> metaDataMap;

    public ActivemqGretaFurhatSender(){
        this(WhiteBoard.DEFAULT_ACTIVEMQ_HOST,
             WhiteBoard.DEFAULT_ACTIVEMQ_PORT,
             "greta.furhat.head.Rotation");
    }

    public ActivemqGretaFurhatSender(String host, String port, String topic){
