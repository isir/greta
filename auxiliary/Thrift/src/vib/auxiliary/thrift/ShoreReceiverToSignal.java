...
import vib.auxiliary.thrift.gen_java.*;
...
public class ShoreReceiverToSignal extends APReceiver implements SignalEmitter {

private List<SignalPerformer> signalPerformers = new ArrayList<SignalPerformer>();

    private ID id1;

    public ShoreReceiverToSignal(int port) {
        super(port);
    }

    public ShoreReceiverToSignal() {
        super();
    }
