...
public class Camera {
    ...
    private Mixer mic;
    private vib.core.util.math.Quaternion rotationAdaptor;
    private vib.core.util.math.Vec3d backgroundColor;
    ...
    public Camera(SceneManager sceneManager, SceneNode parentNode, String idCamera){
        ...
        vib.core.util.CharacterManager.currentCameraId = mic.getIdentifier();
    }
    ...
    private void updateMicOrientation(){
        vib.core.util.math.Quaternion q = Ogre.convert(rollNode._getDerivedOrientation());
