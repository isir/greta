...
//import vib.auxiliary.player.ogre.natives.HardwareBuffer.Usage;
...
public class Ogre {
    ...
    static {
        ...
        System.loadLibrary("playerOgreJNI");
    }
        ...
        if (secnes.contains(sceneName)) {
            ...
            callSync(new OgreThread.Callback() {
                ...
                public void run() {
                    ...
                    //"TerrainSceneManager" "DefaultSceneManager" vib.auxiliary.player.ogre.natives.SceneType.ST_GENERIC.getValue()
...
//                mesh.instance = meshPtr.getPointer();
    ...
    public static vib.auxiliary.player.ogre.natives.Vector3 convert(vib.core.util.math.Vec3d vec) {
        return new vib.auxiliary.player.ogre.natives.Vector3((float)vec.x(), (float)vec.y(), (float)vec.z());
    }

    public static vib.core.util.math.Vec3d convert(vib.auxiliary.player.ogre.natives.Vector3 vec) {
        return new vib.core.util.math.Vec3d(vec.getx(), vec.gety(), vec.getz());
    }

    public static vib.auxiliary.player.ogre.natives.Quaternion convert(vib.core.util.math.Quaternion quat) {
        return new vib.auxiliary.player.ogre.natives.Quaternion(quat.w(), quat.x(), quat.y(), quat.z());
    }

    public static vib.core.util.math.Quaternion convert(vib.auxiliary.player.ogre.natives.Quaternion quat) {
        return new vib.core.util.math.Quaternion(quat.getx(), quat.gety(), quat.getz(), quat.getw());
    }
    ...
    static vib.auxiliary.player.ogre.natives.ColourValue convertToColor(vib.core.util.math.Vec3d vec) {
