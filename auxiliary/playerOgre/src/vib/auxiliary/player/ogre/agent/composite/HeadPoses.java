...
import vib.core.animation.mpeg4.fap.FAP;
...
public class HeadPoses {
    ...
    private void applyOnEyes(FAPFrame fapFrame){
        ...
        if(fap.get(23).getMask() || fap.get(25).getMask()){
            final vib.core.util.math.Quaternion qx =
                    new vib.core.util.math.Quaternion(
                        new vib.core.util.math.Vec3d(1, 0, 0),
                        fap.get(25).getValue()/100000.0f);
            final vib.core.util.math.Quaternion qy =
                    new vib.core.util.math.Quaternion(
                        new vib.core.util.math.Vec3d(0, 1, 0),
                        fap.get(23).getValue()/100000.0f);
            Ogre.call(new OgreThread.Callback() {
                @Override
                public void run() {
                    leftEye.setOrientation(Ogre.convert(vib.core.util.math.Quaternion.multiplication(qy, qx)));
        ...
        if(fap.get(24).getMask() || fap.get(26).getMask()){
            ...
            Ogre.call(new OgreThread.Callback() {
                @Override
                public void run() {
                    rightEye.setOrientation(Ogre.convert(vib.core.util.math.Quaternion.multiplication(qy, qx)));
...
//            vib.auxiliary.player.ogre.natives.ResourcePtr resourceMaterialPTR = new vib.auxiliary.player.ogre.natives.ResourcePtr();
...
//            vib.auxiliary.player.ogre.natives.GpuProgramParameters paramsClonePtr = new vib.auxiliary.player.ogre.natives.GpuProgramParametersSharedPtr();
