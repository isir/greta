...
import vib.auxiliary.player.ogre.OgreEnvironementListener;
...
import vib.core.util.time.ManualTimeController;
...
public class OffLineVideoCapturer implements Runnable, Capturer{
    ...
    public void run(){
        ...
        synchronized (capturable){
            ...
            vib.core.util.audio.Mixer.requestNotBlocking();
        ...
        vib.core.util.audio.Mixer.releaseNotBlocking();
