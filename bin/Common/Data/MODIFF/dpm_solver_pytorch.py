...
#     y_i,
#     steps=100,  # Start with a higher number and reduce incrementally
#     method='adaptive',  # Try different methods: 'multistep', 'singlestep'
#     order=3,  # Adjust the order: 1, 2, or 3
#     skip_type='time_uniform',  # Try 'logSNR', 'time_quadratic'
#     return_intermediate=return_y_trace,
#     solver_type='dpmsolver',  # Experiment with 'taylor' as well
#     atol=0.01,  # Experiment with different tolerance values
#     rtol=0.05
# )
class DPM_Solver:
    def __init__(
