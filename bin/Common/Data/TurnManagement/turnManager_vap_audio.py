    ...
    def main_loop(self):
        ...
        while self.is_active:
            ...
            try:
                ...
                # print('audio concat', time.time() - s_time)

                
                # print(data.type, data.shape, flush=True)
                # print(data.type, data.shape, data.device)
                ...
                # audio VAP
                # print('VAP inference start')
                result = self.model(waveform = data)
                # print('VAP inference end')
                ...
                # print("VAP inference loop", e_time - s_time, flush=True)
