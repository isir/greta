...
<!-- <face id="blink" type="facs" au="45" amount="0.4" start="0" end="0.1" side="BOTH"/>
	<head id="anticipation<xsl:value-of select="$ready_time" />" type="nod" velocity="1" amount="-0.02" repeats="0.5"/>
	<head id="action<xsl:value-of select="$ready_time" />" type="nod" velocity="1" amount="0.2" repeats="1" start="anticipation<xsl:value-of select="$ready_time" />:relax" relax="anticipation<xsl:value-of select="$ready_time" />:relax+0.8" />
	<head id="overshoot" type="nod" velocity="0.5" amount="0.05" repeats="0.5" start="action<xsl:value-of select="$ready_time" />:relax"/> -->	
<xsl:template name="big_nod">
	...
	<xsl:element name="head">
		<xsl:attribute name="id">anticipation<xsl:value-of select="$ready_time" /></xsl:attribute>	
	...
	<xsl:element name="head">
		<xsl:attribute name="id">action<xsl:value-of select="$ready_time" /></xsl:attribute>	
		<xsl:attribute name="type">NOD</xsl:attribute>		
		<xsl:attribute name="amount">0.5</xsl:attribute>
		<xsl:attribute name="repeats">1</xsl:attribute>
		<xsl:attribute name="start">anticipation<xsl:value-of select="$ready_time" />:relax</xsl:attribute>
		<xsl:attribute name="relax">anticipation<xsl:value-of select="$ready_time" />:relax+1</xsl:attribute>			
		<xsl:attribute name="priority"><xsl:value-of select="$priority" /></xsl:attribute>
	</xsl:element>
	...
	<xsl:element name="head">
		...
		<xsl:attribute name="repeats">0.5</xsl:attribute>
		<xsl:attribute name="start">action<xsl:value-of select="$ready_time" />:relax</xsl:attribute>	
		<xsl:attribute name="priority"><xsl:value-of select="$priority" /></xsl:attribute>
	</xsl:element>
</xsl:template>
...
<!-- <face id="blink" type="facs" au="45" amount="0.4" start="0" end="0.2" side="BOTH"/>
	<head id="anticipation<xsl:value-of select="$ready_time" />" type="nod" velocity="1" amount="-0.01" repeats="0.5"/>
	<head id="action<xsl:value-of select="$ready_time" />" type="nod" velocity="1" amount="0.1" repeats="1" start="anticipation<xsl:value-of select="$ready_time" />:relax" relax="anticipation<xsl:value-of select="$ready_time" />:relax+0.5" />
	<head id="overshoot" type="nod" velocity="0.5" amount="0.04" repeats="0.5" start="action<xsl:value-of select="$ready_time" />:relax"/> -->
<xsl:template name="nod">
	...
	<xsl:element name="head">
		...
		<xsl:attribute name="repeats">1</xsl:attribute>
		<xsl:attribute name="start">anticipation<xsl:value-of select="$ready_time" />:relax</xsl:attribute>
		<xsl:attribute name="relax">anticipation<xsl:value-of select="$ready_time" />:relax+0.6</xsl:attribute>			
		<xsl:attribute name="priority"><xsl:value-of select="$priority" /></xsl:attribute>
	</xsl:element>
...
<!-- small nod -->
<!-- <face id="blink" type="facs" au="45" amount="0.4" start="0" end="0.2" side="BOTH"/>
	<head id="action<xsl:value-of select="$ready_time" />" type="nod" velocity="1" amount="0.05" repeats="1" />
	<head id="overshoot" type="nod" velocity="1" amount="0.01" repeats="0.5" start="action<xsl:value-of select="$ready_time" />:relax"/> -->
...
<!-- big shake -->  
<!-- <head id="anticipation<xsl:value-of select="$ready_time" />" type="shake" amount="-0.03" repeats="0.5"/>
	<head id="action<xsl:value-of select="$ready_time" />" type="shake" amount="0.3" repeats="1" start="anticipation<xsl:value-of select="$ready_time" />:relax"/>
	<head id="overshoot" type="shake" amount="0.03" repeats="0.5" start="action<xsl:value-of select="$ready_time" />:relax" /> -->
...
<!-- shake --> 
<!-- <head id="anticipation<xsl:value-of select="$ready_time" />" type="shake" amount="-0.03" repeats="0.5"/>
	<head id="action<xsl:value-of select="$ready_time" />" type="shake" amount="0.2" repeats="1" start="anticipation<xsl:value-of select="$ready_time" />:relax"/>
	<head id="overshoot" type="shake" amount="0.03" repeats="0.5" start="action<xsl:value-of select="$ready_time" />:relax" /> -->
...
<!-- small shake -->
<!-- <head id="anticipation<xsl:value-of select="$ready_time" />" type="shake" amount="-0.03" repeats="0.5"/>
	<head id="action<xsl:value-of select="$ready_time" />" type="shake" amount="0.1" repeats="1" start="anticipation<xsl:value-of select="$ready_time" />:relax"/>
	<head id="overshoot" type="shake" amount="0.03" repeats="0.5" start="action<xsl:value-of select="$ready_time" />:relax" /> -->
...
<!-- shake twice --> 
<!-- <head id="anticipation<xsl:value-of select="$ready_time" />" type="shake" amount="-0.03" repeats="0.5"/>
	<head id="action<xsl:value-of select="$ready_time" />" type="shake" amount="0.1" repeats="2" velocity="1.6" start="anticipation<xsl:value-of select="$ready_time" />:relax"/>
	<head id="overshoot" type="shake" amount="0.03" repeats="0.5" start="action<xsl:value-of select="$ready_time" />:relax" /> -->
...
<xsl:template name="ani_first_VP">
	...
	<xsl:element name="animation">
		...
		<xsl:attribute name="priority"><xsl:value-of select="$priority" /></xsl:attribute>
		<xsl:attribute name="name"> <xsl:value-of select="external:xslGetAnimation('first_VP', $posture, $participant )" /></xsl:attribute> 
	</xsl:element>	
</xsl:template>
...
<xsl:template name="ani_you">
	...
	<xsl:element name="animation">
		...
		<xsl:attribute name="stroke"><xsl:value-of select="$speech_id" />:<xsl:value-of select="$stroke" /></xsl:attribute>
		<xsl:attribute name="priority"><xsl:value-of select="$priority" /></xsl:attribute>		
		<xsl:attribute name="name"> <xsl:value-of select="external:xslGetAnimation('you_animation', $posture, $participant )" /></xsl:attribute> 
...
<xsl:template name="ani_me">
	...
	<xsl:element name="animation">
		...
		<xsl:attribute name="stroke"><xsl:value-of select="$speech_id" />:<xsl:value-of select="$stroke" /></xsl:attribute>
		<xsl:attribute name="priority"><xsl:value-of select="$priority" /></xsl:attribute>
		<xsl:attribute name="name"> <xsl:value-of select="external:xslGetAnimation('me_animation', $posture, $participant)" /></xsl:attribute> 
	</xsl:element>	
</xsl:template>
...
<xsl:template name="ani_negation">
	...
	<xsl:element name="animation">
		...
		<xsl:attribute name="stroke"><xsl:value-of select="$speech_id" />:<xsl:value-of select="$stroke" /></xsl:attribute>
		<xsl:attribute name="priority"><xsl:value-of select="$priority" /></xsl:attribute>			
		<xsl:attribute name="name"> <xsl:value-of select="external:xslGetAnimation('negation_animation', $posture, $participant )" /></xsl:attribute> 
	</xsl:element>	
</xsl:template>
...
<xsl:template name="ani_contrast">
	...
	<xsl:element name="animation">
		...
		<xsl:attribute name="stroke"><xsl:value-of select="$speech_id" />:<xsl:value-of select="$stroke" /></xsl:attribute>
		<xsl:attribute name="priority"><xsl:value-of select="$priority" /></xsl:attribute>
		<xsl:attribute name="name"> <xsl:value-of select="external:xslGetAnimation('contrast_animation', $posture, $participant )" /></xsl:attribute> 
	</xsl:element>	
</xsl:template>
...
<xsl:template name="ani_assumption">
	...
	<xsl:element name="animation">
		...
		<xsl:attribute name="stroke"><xsl:value-of select="$speech_id" />:<xsl:value-of select="$stroke" /></xsl:attribute>
		<xsl:attribute name="priority"><xsl:value-of select="$priority" /></xsl:attribute>
		<xsl:attribute name="name"> <xsl:value-of select="external:xslGetAnimation('assumption_animation', $posture, $participant)" /></xsl:attribute> 
	</xsl:element>	
</xsl:template>
...
<xsl:template name="ani_rhetorical">
	...
	<xsl:element name="animation">
		...
		<xsl:attribute name="stroke"><xsl:value-of select="$speech_id" />:<xsl:value-of select="$stroke" /></xsl:attribute>
		<xsl:attribute name="priority"><xsl:value-of select="$priority" /></xsl:attribute>
		<xsl:attribute name="name"> <xsl:value-of select="external:xslGetAnimation('rhetorical_animation', $posture, $participant)" /></xsl:attribute> 
	</xsl:element>	
</xsl:template>
...
<xsl:template name="ani_inclusivity">
	...
	<xsl:element name="animation">
		...
		<xsl:attribute name="stroke"><xsl:value-of select="$speech_id" />:<xsl:value-of select="$stroke" /></xsl:attribute>
		<xsl:attribute name="priority"><xsl:value-of select="$priority" /></xsl:attribute>
		<xsl:attribute name="name"> <xsl:value-of select="external:xslGetAnimation('inclusivity_animation', $posture, $participant )" /></xsl:attribute> 
	</xsl:element>	
</xsl:template>
...
<xsl:template name="ani_question">
	...
	<xsl:element name="animation">
		...
		<xsl:attribute name="stroke"><xsl:value-of select="$speech_id" />:<xsl:value-of select="$stroke" /></xsl:attribute>
		<xsl:attribute name="priority"><xsl:value-of select="$priority" /></xsl:attribute>
		<xsl:attribute name="name"> <xsl:value-of select="external:xslGetAnimation('question_animation', $posture, $participant)" /></xsl:attribute> 
	</xsl:element>	
</xsl:template>
...
<xsl:template name="ani_obligation">
	...
	<xsl:element name="animation">
		...
		<xsl:attribute name="stroke"><xsl:value-of select="$speech_id" />:<xsl:value-of select="$stroke" /></xsl:attribute>
		<xsl:attribute name="priority"><xsl:value-of select="$priority" /></xsl:attribute>
		<xsl:attribute name="name"> <xsl:value-of select="external:xslGetAnimation('obligation_animation', $posture, $participant)" /></xsl:attribute> 
	</xsl:element>	
</xsl:template>
...
<xsl:template name="ani_greeting">
	...
	<xsl:element name="animation">
		...
		<xsl:attribute name="stroke"><xsl:value-of select="$speech_id" />:<xsl:value-of select="$stroke" /></xsl:attribute>
		<xsl:attribute name="priority"><xsl:value-of select="$priority" /></xsl:attribute>
		<xsl:attribute name="name"> <xsl:value-of select="external:xslGetAnimation('greeting_animation', $posture, $participant)" /></xsl:attribute> 
	</xsl:element>	
</xsl:template>
...
<xsl:template name="ani_right">
	...
	<xsl:element name="animation">
		...
		<xsl:attribute name="stroke"><xsl:value-of select="$speech_id" />:<xsl:value-of select="$stroke" /></xsl:attribute>
		<xsl:attribute name="priority"><xsl:value-of select="$priority" /></xsl:attribute>
		<xsl:attribute name="name"> <xsl:value-of select="external:xslGetAnimation('right_animation', $posture, $participant)" /></xsl:attribute> 
	</xsl:element>	
</xsl:template>
...
<xsl:template name="ani_left">
	...
	<xsl:element name="animation">
		...
		<xsl:attribute name="stroke"><xsl:value-of select="$speech_id" />:<xsl:value-of select="$stroke" /></xsl:attribute>
		<xsl:attribute name="priority"><xsl:value-of select="$priority" /></xsl:attribute>
		<xsl:attribute name="name"> <xsl:value-of select="external:xslGetAnimation('left_animation', $posture, $participant)" /></xsl:attribute> 
	</xsl:element>	
</xsl:template>
...
<xsl:template name="ani_chop">
	...
	<xsl:element name="animation">
		...
		<xsl:attribute name="stroke"><xsl:value-of select="$speech_id" />:<xsl:value-of select="$stroke" /></xsl:attribute>
		<xsl:attribute name="priority"><xsl:value-of select="$priority" /></xsl:attribute>
		<xsl:attribute name="name"> <xsl:value-of select="external:xslGetAnimation('chop_animation', $posture, $participant)" /></xsl:attribute> 
	</xsl:element>	
</xsl:template>
...
<xsl:template name="ani_rubneck">
	...
	<xsl:element name="animation">
		...
		<xsl:attribute name="stroke"><xsl:value-of select="$speech_id" />:<xsl:value-of select="$stroke" /></xsl:attribute>
		<xsl:attribute name="priority"><xsl:value-of select="$priority" /></xsl:attribute>
		<xsl:attribute name="name"> <xsl:value-of select="external:xslGetAnimation('rubneck_animation', $posture, $participant)" /></xsl:attribute> 
	</xsl:element>	
</xsl:template>
...
<xsl:template name="ani_rubneckloop">
	...
	<xsl:element name="animation">
		...
		<xsl:attribute name="stroke"><xsl:value-of select="$speech_id" />:<xsl:value-of select="$stroke" /></xsl:attribute>
		<xsl:attribute name="priority"><xsl:value-of select="$priority" /></xsl:attribute>
		<xsl:attribute name="name"> <xsl:value-of select="external:xslGetAnimation('rubneckloop_animation', $posture, $participant)" /></xsl:attribute> 
	</xsl:element>	
</xsl:template>
...
<xsl:template name="ani_rubhead">
	...
	<xsl:element name="animation">
		...
		<xsl:attribute name="stroke"><xsl:value-of select="$speech_id" />:<xsl:value-of select="$stroke" /></xsl:attribute>
		<xsl:attribute name="priority"><xsl:value-of select="$priority" /></xsl:attribute>
		<xsl:attribute name="name"> <xsl:value-of select="external:xslGetAnimation('rubhead_animation', $posture, $participant)" /></xsl:attribute> 
	</xsl:element>	
</xsl:template>
...
<xsl:template name="ani_rubheadloop">
	...
	<xsl:element name="animation">
		...
		<xsl:attribute name="stroke"><xsl:value-of select="$speech_id" />:<xsl:value-of select="$stroke" /></xsl:attribute>
		<xsl:attribute name="priority"><xsl:value-of select="$priority" /></xsl:attribute>
		<xsl:attribute name="name"> <xsl:value-of select="external:xslGetAnimation('rubheadloop_animation', $posture, $participant)" /></xsl:attribute> 
	</xsl:element>	
</xsl:template>
...
<xsl:template name="ani_contemplate">
	...
	<xsl:element name="animation">
		...
		<xsl:attribute name="stroke"><xsl:value-of select="$speech_id" />:<xsl:value-of select="$stroke" /></xsl:attribute>
		<xsl:attribute name="priority"><xsl:value-of select="$priority" /></xsl:attribute>
		<xsl:attribute name="name"> <xsl:value-of select="external:xslGetAnimation('contemplate_animation', $posture, $participant)" /></xsl:attribute> 
	</xsl:element>	
</xsl:template>
...
<xsl:template name="ani_contemplateloop">
	...
	<xsl:element name="animation">
		...
		<xsl:attribute name="stroke"><xsl:value-of select="$speech_id" />:<xsl:value-of select="$stroke" /></xsl:attribute>
		<xsl:attribute name="priority"><xsl:value-of select="$priority" /></xsl:attribute>
		<xsl:attribute name="name"> <xsl:value-of select="external:xslGetAnimation('contemplateloop_animation', $posture, $participant)" /></xsl:attribute> 
	</xsl:element>	
</xsl:template>
...
<xsl:template name="ani_dismissrarm">
	...
	<xsl:element name="animation">
		...
		<xsl:attribute name="stroke"><xsl:value-of select="$speech_id" />:<xsl:value-of select="$stroke" /></xsl:attribute>
		<xsl:attribute name="priority"><xsl:value-of select="$priority" /></xsl:attribute>
		<xsl:attribute name="name"> <xsl:value-of select="external:xslGetAnimation('dismissrarm_animation', $posture, $participant)" /></xsl:attribute> 
	</xsl:element>	
</xsl:template>
...
<xsl:template name="ani_grabchinloop">
	...
	<xsl:element name="animation">
		...
		<xsl:attribute name="stroke"><xsl:value-of select="$speech_id" />:<xsl:value-of select="$stroke" /></xsl:attribute>
		<xsl:attribute name="priority"><xsl:value-of select="$priority" /></xsl:attribute>
		<xsl:attribute name="name"> <xsl:value-of select="external:xslGetAnimation('grabchinloop_animation', $posture, $participant)" /></xsl:attribute> 
	</xsl:element>	
</xsl:template>
...
<xsl:template name="ani_horizontal">
	...
	<xsl:element name="animation">
		...
		<xsl:attribute name="stroke"><xsl:value-of select="$speech_id" />:<xsl:value-of select="$stroke" /></xsl:attribute>
		<xsl:attribute name="priority"><xsl:value-of select="$priority" /></xsl:attribute>
		<xsl:attribute name="name"> <xsl:value-of select="external:xslGetAnimation('horizontal_animation', $posture, $participant)" /></xsl:attribute> 
	</xsl:element>	
</xsl:template>
  ...
  <xsl:template name="idle_gaze_aversion">
    ...
    <xsl:variable name="offset">
      <xsl:value-of select="external:xslGetAnimation('idle_gaze', $posture, $participant)" />
    </xsl:variable>
  ...
  <!-- idle-animation animation -->
	<xsl:template name="idle_anim">
		...
		<xsl:element name="animation">
			<xsl:attribute name="priority"><xsl:value-of select="$priority" /></xsl:attribute>
			<xsl:attribute name="name"> <xsl:value-of select="external:xslGetAnimation('idle_animation', $posture, $participant)" />			</xsl:attribute> 
		</xsl:element>	
	</xsl:template>
