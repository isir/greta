 ...
 * @has - - * vib.core.behaviorplanner.baseline.Qualifier
 * @navassoc - "computes" - vib.core.behaviorplanner.baseline.DynamicLine
 */
...
//constructors :
     ...
     * @see
     * vib.core.util.parameter.ParameterSet#addDefinition(java.lang.String)
     * addDefinition(String)
     * @see
     * vib.core.util.parameter.ParameterSet#setDefinition(java.lang.String)
