...
package vib.core.behaviorplanner.lexicon;

import vib.core.behaviorplanner.mseconstraints.MultimodalEmotionConstraintSet;
 ...
 * @has - - * vib.core.behaviorplanner.lexicon.BehaviorSet
 */
public class Lexicon extends ParameterSet<BehaviorSet> implements CharacterDependent{
    ...
    protected List<BehaviorSet> load(String definition) {
        ...
        vib.core.behaviorplanner.mseconstraints.ConstraintSetsContainer csc = new vib.core.behaviorplanner.mseconstraints.ConstraintSetsContainer();
