...
import vib.core.animation.rbdl.DBody;
import vib.core.animation.rbdl.DJoint;
import vib.core.animation.rbdl.DModel;
import vib.core.animation.rbdl.Dynamics;
import vib.core.animation.rbdl.HingeJoinController;
import vib.core.animation.rbdl.SpatialTransform;
...
public class RelaxArmDynamicsMotion {
    ...
    public void setSkeleton(Skeleton sk) {
        ...
        if (_side.equalsIgnoreCase("left")) {
            vib.core.animation.Joint j_shoulder = sk.getJoint("l_shoulder");
            posShoulder = j_shoulder.getWorldPosition();
            vib.core.animation.Joint j_elbow = sk.getJoint("l_elbow");
            posElbow = j_elbow.getWorldPosition();
            vib.core.animation.Joint j_wrist = sk.getJoint("l_wrist");
            posWrist = j_wrist.getWorldPosition();

        } else {
            vib.core.animation.Joint j_shoulder = sk.getJoint("r_shoulder");
            posShoulder = j_shoulder.getWorldPosition();
            vib.core.animation.Joint j_elbow = sk.getJoint("r_elbow");
            posElbow = j_elbow.getWorldPosition();
            vib.core.animation.Joint j_wrist = sk.getJoint("r_wrist");
            posWrist = j_wrist.getWorldPosition();
        }
