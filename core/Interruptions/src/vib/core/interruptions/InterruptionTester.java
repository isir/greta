 ...
 */
package vib.core.interruptions;
...
import vib.core.interruptions.reactions.BehaviorType;
import vib.core.interruptions.reactions.InterruptionReaction;
import vib.core.interruptions.reactions.InterruptionReactionEmitter;
import vib.core.interruptions.reactions.InterruptionReactionImpl;
import vib.core.interruptions.reactions.InterruptionReactionParameters;
import vib.core.interruptions.reactions.InterruptionReactionPerformer;
...
public class InterruptionTester extends javax.swing.JFrame implements IntentionEmitter, InterruptionReactionEmitter, CharacterDependent {
    ...
    /* ---------------------------------------------------------------------- */
    /*             Inspired by vib.core.intentions.FMLFileReader              */
    /* ---------------------------------------------------------------------- */
    ...
    /* ---------------------------------------------------------------------- */
    /*               Inspired by vib.core.utilx.gui.OpenAndLoad               */
    /* ---------------------------------------------------------------------- */
    ...
    private void testInterruptionButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_testInterruptionButtonActionPerformed
        ...
        if (interruptionOnOffCheckBox.isSelected()) {
            ...
            if (interruptionTime != 0) {
                ...
                vib.core.util.time.Timer.sleep(interruptionTime);
