 ...
 * @see vib.core.util.log.LogOutput interface LogOutput
 * @see vib.core.util.log.LogPrinter LogPrinter
 * @see vib.core.util.log.LogFile LogFile
 * @author Andre-Marie Pez
 *
 * the following tags generate a warning in Javadoc generation because
 * they are UmlGraph tags, not javadoc tags.
 * @composed - - * vib.core.util.log.LogOutput
 */
public class Logs {
//Private members
    /**
...
//Public members
     ...
     * @see vib.core.util.log.LogOutput LogOutput
     ...
     * @see #add(vib.core.util.log.LogOutput) add
     */
