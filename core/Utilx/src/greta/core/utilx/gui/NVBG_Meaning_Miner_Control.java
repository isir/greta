 ...
 */
public class NVBG_Meaning_Miner_Control extends javax.swing.JFrame {

    private CharacterManager cm;

    /** Creates new form TTSController */
    public NVBG_Meaning_Miner_Control(CharacterManager cm) {
        this.cm = cm;
        initComponents();
        updateTTSOptions();
    }
    ...
    private void updateTTSOptions(){
            this.cm.set_use_MM( doTemporize.isSelected());
            this.cm.set_use_NVBG( doAudio.isSelected());
    }
